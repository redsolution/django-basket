...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('basket_order', 'status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['basket.Status'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('basket_orderstatus', (
            ...
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 10, 6, 11, 14, 27, 802122))),
        ...
        db.delete_column('basket_order', 'status_id')
    ...
    models = {
        ...
        'basket.order': {
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['basket.Status']", 'null': 'True', 'blank': 'True'}),
