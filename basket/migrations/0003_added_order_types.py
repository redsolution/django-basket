...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.Status.objects.create(name=u'новый')
        orm.Status.objects.create(name=u'оплачено')
        orm.Status.objects.create(name=u'отправлено', closed=True)
        orm.Status.objects.create(name=u'ошибка')

    def backwards(self, orm):
        "Write your backwards methods here."
        orm.Status.objects.all().delete()
    ...
    models = {
        ...
        'basket.orderstatus': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 4, 2, 23, 11, 20, 64313)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
