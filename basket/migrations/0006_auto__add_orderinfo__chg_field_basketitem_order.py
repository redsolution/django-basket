...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('basket_orderinfo', (
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('delivery_type', self.gf('django.db.models.fields.CharField')(default='undefined', max_length=100)),
            ('delivery_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('registered', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('contact_time', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('telephone', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('fio', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ...
            ('delivery_cost', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['basket.Order'], unique=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('trans_company', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal('basket', ['OrderInfo'])

        # Changing field 'BasketItem.order'
        db.alter_column('basket_basketitem', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['basket.Order']))
    
    
    def backwards(self, orm):
        
        # Deleting model 'OrderInfo'
        db.delete_table('basket_orderinfo')

        # Changing field 'BasketItem.order'
        db.alter_column('basket_basketitem', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['basket.Order']))
    ...
    models = {
        ...
        'basket.orderstatus': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 5, 14, 39, 41, 178207)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
