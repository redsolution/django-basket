...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'States'
        db.create_table('basket_states', (
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal('basket', ['States'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'States'
        db.delete_table('basket_states')
    ...
    models = {
        ...
        'basket.orderstatus': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 5, 15, 57, 43, 266650)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
