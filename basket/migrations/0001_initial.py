...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('basket_basketitem', (
            ('basket', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', to=orm['basket.Basket'])),
    ...
    models = {
        ...
        'basket.basket': {
            ...
            'delivered': ('django.db.models.fields.NullBooleanField', [], {'null': 'True'}),
