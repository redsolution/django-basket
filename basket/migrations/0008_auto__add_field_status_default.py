...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Status.default'
        db.add_column('basket_status', 'default', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Status.default'
        db.delete_column('basket_status', 'default')
    ...
    models = {
        ...
        'basket.orderstatus': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 24, 22, 42, 28, 596000)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
